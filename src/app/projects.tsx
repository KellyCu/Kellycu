                            ...
                            return(
                                <div key={index} className="relative md:left-5 xs:w-11/12 xs:h-80 sm:w-3/4 sm:h-60 xl:h-64 md:w-4/5 lg:w-3/5 flex xs:flex-col sm:flex-row items-center border rounded-lg mb-5 xs:p-1 shadow-lg shadow-white/20">
                                    ...
                                    <div className=" relative sm:-left-4 xl:-left-6 flex flex-col justify-center items-center sm:w-3/5 md:w-3/4 lg:w-10/12 sm:h-full">
                                        <h1 className="text-white textglow2 xs:text-2xl sm:text-3xl md:text-2xl xl:text-3xl font-bold font-mono mb-3">{box.name}</h1>
                                        <p className="text-white textglow2 xs:text-sm sm:text-xs xl:text-sm font-semibold text-center">{box.info}</p>
                                    </div>
                                </div>
                            )
                        })}
